...
class CritiqueForm(forms.ModelForm):
    ...
    modifier_critique = forms.BooleanField(widget=forms.HiddenInput,
                                           initial=True)
...
class SupprimerCritiqueForm(forms.Form):
    supprimer_critique = forms.BooleanField(widget=forms.HiddenInput,
                                            initial=True)
